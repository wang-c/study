package com.github.tjp.concurrent.limiter;
...
import com.github.tjp.concurrent.limiter.SmoothRateLimiter.SmoothBursty;
import com.github.tjp.concurrent.limiter.SmoothRateLimiter.SmoothWarmingUp;
...
//                permitsPerSecond > 0.0 && !Double.isNaN(permitsPerSecond), "rate must be positive");
    ...
    private boolean canAcquire(long nowMicros, long timeoutMicros) {
        System.out.println("timeout canAcquire , nextFreeTicketMicros:"+queryEarliestAvailable(nowMicros)+",(nowMicros+timeoutMicros):"+nowMicros+timeoutMicros);
        return queryEarliestAvailable(nowMicros)<= nowMicros+timeoutMicros;
    }
